...
async function commitJsonFiles({ files, message }) {
  const { ref, parent } = await repositoryState(Object.keys(files)[0], null);
  const entries = [];
...
module.exports = { repositoryState, commitJson, commitJsonFiles };
